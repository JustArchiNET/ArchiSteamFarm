...
namespace ArchiSteamFarm {
	...
	public sealed class BotConfig {
		...
		internal enum EBotBehaviour : byte {
			...
			MarkReceivedTradeMessagesAsRead = 32,
			All = RejectInvalidFriendInvites | RejectInvalidTrades | RejectInvalidGroupInvites | DismissInventoryNotifications | MarkReceivedMessagesAsRead | MarkReceivedTradeMessagesAsRead
		}
